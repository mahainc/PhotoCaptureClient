...
extension PhotoCaptureClient {
    /// How detection overlays are drawn on the live preview.
    public enum OverlayStyle: Sendable, Equatable {
        /// Rounded bounding boxes, one per fully-visible object (default).
        case boxes
        /// A single animated dot at the center of the object nearest the screen center.
        case centerDot
    }
}
